...
export const activities: Activity[] = [
  ...
  // 2. Past Events - Reverse chronological order (most recent first)
  {
    ...
    description: "Dariya Dalabayeva took part in the AI & Methods in Computational Communication (AIM-CC 2026) Young Scholar Conference & Research School, delivering a talk on her mixed-methods research titled \"At the Intersection of Entrepreneurship, Innovation, and Artificial Intelligence: The Case of IT Startups from Kazakhstan\". Drawing on findings from an empirical study in Astana and Almaty—including 16 semi-structured interviews and digital ethnographic non-participant observations with NLP analysis elements—the research explores how the perception of innovation evolves when artificial intelligence is integrated into the ideation and opportunity-seeking processes of Kazakhstani IT startups.",
    type: "past",
