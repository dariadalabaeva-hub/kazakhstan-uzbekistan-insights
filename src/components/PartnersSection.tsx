...
const partnerNameOverrides: Record<Locale, Record<string, string>> = {
  ...
  ru: {
    "nurce": "Исследовательский Центр Предпринимательства Назарбаев Университета",
    "cas-seminar": "Департамент Азиатских и Африканских Исследований, Семинар по Центральной Азии",
    "isdc": "Международный Центр Безопасности и Развития, Берлин",
    "bmu": "Британский Университет Менеджмента, Ташкент",
  },
};
